...
# Local imports
from collator import TestCollator, TestCollator4Rec
...
from verify_acc import compute_dataset_token_accuracy,simple_collate_fn_for_prompt_completion
...
def test_index_location(args):
    ...
    if args.test_prompt_ids == "all":
        prompt_map = {
            ...
            "index": all_prompt["index2location"],
            "location": all_prompt["location2index"]
        }
    ...
    collator4rec = TestCollator4Rec(args, tokenizer)
    ...
    with torch.no_grad():
        for prompt_id in prompt_ids:
            ...
            test_HF_Dataset = HF_Dataset.from_list(processed_test)
