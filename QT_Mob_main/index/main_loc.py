...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str,
                        default="hex2vec-main/data/processed/Tokyo, Japan/location_tokyo.feather",
    ...
    parser.add_argument('--num_emb_list', type=int, nargs='+', default=[128,64,64], help='emb num of every vq')
    ...
    parser.add_argument('--layers', type=int, nargs='+', default=[64, 32], help='hidden sizes of every layer')

    parser.add_argument('--save_limit', type=int, default=5)
    parser.add_argument("--ckpt_dir", type=str, default="liandanlu/loc", help="output directory for model")
